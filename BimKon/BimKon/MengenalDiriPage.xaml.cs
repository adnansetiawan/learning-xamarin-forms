...
namespace BimKon.Core
{
    public partial class MengenalDiriPage : MasterPage
    {
        public MengenalDiriPage()
        {
            ...
            fs.Spans.Add(new Span { Text = "Kamu-kamu yang berstatus siswa SMP, pastilah sering mengalami galau dan bingung, bingung?? Ya… Bingung utamanya menentukan di sekolah mana kita akan lanjut setelah tamat SMP??? Kebingungan ini muncul ketika kita tidak mengenal diri kita, mengenal bakat, minat dan kemampuan diri sendiri.\n\n", FontSize = 12 });
            fs.Spans.Add(new Span { Text = "Nah melalui aplikasi ini akan diuraikan secara singkat enam tipe kepribadian, yang bisa saja adik-adik masuk diantara enam kepribadian tersebut, yuk dibaca agar lebih paham :\n", FontSize = 12 });
